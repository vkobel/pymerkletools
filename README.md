...
mt = MerkleTools(hash_function=hashlib.sha512)  # default is sha256 
```
...
Adds a value as a leaf or a list of leafs to the tree. All values are hashed prior to being added to the tree. 
...
```python
proof = [
   { r: '09096dbc49b7909917e13b795ebf289ace50b870440f10424af8845fb7761ea5' },
   { r: 'ed2456914e48c1e17b7bd922177291ef8b7f553edf1b1f66b6fc1a076524b22f' },
   { l: 'eac53dde9661daf47a428efea28c81a021c06d64f98eeabbdcff442d992153a8' },
]
...
print mt.get_proof(1)  # [{l: '2da7240f6c88536be72abe9f04e454c6478ee29709fc3729ddfb942f804fbf08'},
                       #  {r: 'ef7797e13d3a75526946a3bcf00daec9fc9c9c4d51ddc7cc5df888f74dd434d1'}] 
...
1. Internally, leaves are stored as `bytes`. When the tree is built, it is generated by hashing together the `bytes` values. 
...
hex_string = hash.hex()  # 'ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb'
